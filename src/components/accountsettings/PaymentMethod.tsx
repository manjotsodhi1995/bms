...
const PaymentMethod = () => {
  ...
  return (
    <div className="flex flex-col items-start sm:w-[75%] w-full sm:pl-[80px] mt-[50px] m-5 sm:m-0 bg-white">
      ...
      <form onSubmit={formSubmitHandler} className="flex flex-col">
        ...
        <button
          type="submit"
          className="bg-black text-white rounded-md w-fit p-[5px] px-[20px] text-sm mx-auto mt-[50px]"
        >
          SAVE
        </button>
      </form>
