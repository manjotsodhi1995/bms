...
const CustomerReviewCard: React.FC<CustomerReviewProps> = ({
  ...
  return (
    <div
      ...
      className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg shadow-gray-400 mx-4 min-w-[300px] max-w-xs"
    >
      ...
      <p className="text-gray-700 text-center my-6">{text}</p>
