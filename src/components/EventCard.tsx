...
function EventCard(event: Partial<EventType>) {
  ...
  return (
    <div
      className="place-self-center rounded-3xl shadow:lg transition-transform duration-300 ease-in-out  bg-white pb-2 md:w-[25vw] lg:w-[20vw]  max-w-[350px] border-[#BCBCBC36] border-2 cursor-pointer relative h-full"
        ...
        <div className="w-full">
          ...
          <div className="p-2 flex w-full md:gap-4 gap-2 justify-center align-middle items-center">
            ...
            <div>
              ...
              <div className="flex text-[#A48A00] justify-left font-medium text-[0.7rem] md:text-[0.9rem] lg:text-[1.1rem] 2xl:text-[1.6rem] leading-tight pr-4 lg:h-[3rem] 2xl:h-[4rem] line-clamp-2">
                {event.title}
              </div>
              <div className="flex justify-left text-[0.4rem] md:text-[0.6rem] 2xl:text-[0.9rem] max-lines">
