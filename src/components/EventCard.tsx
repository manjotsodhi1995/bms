...
function EventCard(event: Partial<EventType>) {
  ...
  return (
    <div
      className="h-full w-full place-self-center rounded-3xl shadow:lg transition-transform duration-300 ease-in-out  bg-white pb-2 border-[#BCBCBC36] border-2 cursor-pointer relative"
        ...
        <div className="w-full">
          <div className="relative">
            <img
              src={event.posterUrl}
              alt=""
              className="w-full rounded-2xl h-[14rem] md:h-[18rem] object-fill -z-10"
            />
            <svg
              width="18"
              height="22"
              ...
              className="size-6 absolute md:bottom-4 md:right-4 bottom-2 right-2 fill-white hover:fill-blue-300"
          ...
          <div className="p-2 flex w-full md:gap-4 gap-2 justify-center align-middle items-center">
            ...
            <div>
              ...
              <div className="text-[#A48A00] font-medium text-[0.7rem] md:text-[0.9rem] lg:text-[1.1rem] 2xl:text-[1.6rem] leading-tight pr-4 lg:h-[1rem] 2xl:h-[2rem] line-clamp-1">
                {event.title}
              </div>
