    ...
    <HomeContainerCard className="h-[35vh] col-span-2 md:col-span-1">
      ...
      <div className="flex justify-between px-5 py-2 ">
        ...
        <div className="flex gap-2 items-center">
          ...
          >
            <path
              d="M2.54865 2.66362L1.11158 11.3279C0.990076 12.0576 0.930001 12.4228 1.13183 12.661C1.3323 12.9 1.70018 12.9 2.4366 12.9H2.70795C3.26348 12.9 3.5409 12.9 3.73058 12.7353C3.91958 12.5699 3.9594 12.2938 4.0377 11.741L4.3536 9.52027C4.37858 9.34477 4.39073 9.25702 4.4103 9.1821C4.47813 8.91951 4.62386 8.6836 4.82832 8.50541C5.03277 8.32722 5.28638 8.21509 5.55578 8.18377C5.63205 8.175 5.72048 8.175 5.89665 8.175H6.681C7.69757 8.17322 8.68329 7.8257 9.47621 7.18955C10.2691 6.5534 10.8221 5.66645 11.0442 4.67445C11.4992 2.6643 9.97905 0.75 7.92773 0.75H4.79573C4.04378 0.75 3.66848 0.75 3.37148 0.908625C3.20273 0.999075 3.05423 1.12463 2.93813 1.27785C2.7336 1.54582 2.67218 1.91842 2.54865 2.66362Z"
              stroke="black"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M3.86297 12.5629L3.70907 13.462C3.63819 13.8737 3.95882 14.2504 4.38137 14.2504H5.72462C6.05874 14.2504 6.34359 14.0114 6.39827 13.6861L6.89102 10.764C6.94502 10.4387 7.23054 10.2004 7.56399 10.2004H8.78102C10.5232 10.2004 12.0318 9.00362 12.4098 7.32152C12.6744 6.14364 12.0986 5.00964 11.1239 4.46289"
              stroke="black"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
