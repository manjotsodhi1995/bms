  ...
  return (
    ...
    >
      <div className="w-full rounded-3xl relative h-full">
        ...
        />
        <div className="bg-[rgb(255,255,255,0.2)] backdrop-blur-2xl md:p-2 py-1 absolute bottom-[0rem] z-20 w-full flex flex-col gap-1 md:rounded-b-3xl rounded-b-xl border b-1">
          <div className="flex justify-center font-medium text-[0.8rem] md:text-[0.9rem] lg:text-[1.1rem] 2xl:text-[1.2rem] text-white">
            {title}
          </div>
          <div className="text-white px-2 2xl:px-4 flex justify-center text-center text-[0.4rem] md:text-[0.6rem] 2xl:text-[1.4rem]">
            {description}
          </div>
        </div>
      </div>
