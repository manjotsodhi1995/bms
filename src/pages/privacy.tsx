        ...
        <div className="flex flex-col w-full pt-4 gap-10 md:border-l pl-4 border-black">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              <div>
                This privacy notice for Kafsco Limited (doing business as
                ...
                contact us at kafscoteam@gmail.com.
              </div>
              <p>
              ...
              <p>
                ...
                stored by New Payment Innovation (NPI) and Revolut. You may find
                their privacy notice link(s) here: __________ and __________.
              </p>
              <p>
              ...
              <ul>
                <li>
                  ...
                  including your mobile device's calendar, and other features.
              ...
              <p>
                ...
                email us at hello@kafsco.com or contact us by post at:
              </p>
              <p>Kafsco Limited</p>
              <p>__________</p>
              <p>Dublin</p>
