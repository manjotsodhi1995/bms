...
const EventDetailPage = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-10 2xl:text-2xl">
      <HomeContainerCard className="h-fit">
        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-14 p-8">
          ...
          <div className="flex flex-col gap-4">
            <span className="2xl:text-xl w-fit border border-black px-4 rounded-full py-1">
            ...
            <div className="flex flex-col gap-2 max-w-xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-700 2xl:text-xl">
                    {" "}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-gray-700 2xl:text-xl">{date}</div>
              </div>
              <span className="font-semibold mt-2">Ticket price: 140$</span>

              <button className="md:mt-8 flex w-full 2xl:w-2/3  items-center justify-center gap-2 bg-black text-white py-2 px-4 rounded-xl">
                Rep this event{" "}
                <svg
                  width="15"
                  height="16"
      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-[42%_56%] gap-6 justify-between">
        <HomeContainerCard className="flex w-full flex-col h-full justify-between p-14">
          <p className="font-medium text-xl 2xl:text-3xl">Comission Earned</p>
        ...
        <HomeContainerCard className="flex-row items-center h-full p-14 justify-between">
          <div className="w-full space-y-6">
            <p className="font-medium text-xl 2xl:text-3xl">Organised by:</p>
            <div className="flex items-center justify-between gap-4 font-[600] text-xl 2xl:text-3xl text-[#60769D]">
  ...
  return (
    <div className="relative shadow-custom py-12 px-8 rounded-md w-full bg-blue-box">
      <Table className="text-nowrap">
        <TableHeader className="text-lg 2xl:text-2xl">
